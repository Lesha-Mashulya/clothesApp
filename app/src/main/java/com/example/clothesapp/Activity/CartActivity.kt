...
import com.example.clothesapp.Helper.ChangeNumberItemsListener
import com.example.clothesapp.Helper.ManagmentCart
...
fun CartItem(
    ...
    ConstraintLayout(
        ...
        Text(text = "$${item.price}", color = colorResource(R.color.darkBrown), modifier = Modifier
